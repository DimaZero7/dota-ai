# OpenDota data: 8936008930

Source: https://api.opendota.com/api/matches/8936008930
Retrieved UTC: 2026-09-05T15:02:38.802789+00:00
...
| --- | --- | --- | --- | --- | --- | --- |
| 0 | 74042858 | 74 | 2/12/19 | 348 | 498 | 76 |
| 1 | 1121841406 | 30 | 10/11/17 | 406 | 463 | 40 |
| 2 | 901917641 | 8 | 6/8/8 | 440 | 562 | 233 |
| 3 | 432740170 | 14 | 9/11/12 | 430 | 591 | 123 |
| 4 | 212307295 | 2 | 7/14/5 | 399 | 490 | 135 |
| 128 | 106631507 | 85 | 4/6/27 | 501 | 818 | 150 |
| 129 | 1921459861 | 63 | 29/1/8 | 775 | 1111 | 224 |
| 130 | 1084637361 | 33 | 8/11/21 | 605 | 635 | 159 |
| 131 | 488638060 | 123 | 5/8/15 | 380 | 666 | 68 |
| 132 | 203182675 | 64 | 9/8/18 | 571 | 912 | 178 |
...
| `deaths` | value | 8 |
| `assists` | value | 18 |
| `net_worth` | value | 17238 |
| `gold_per_min` | value | 571 |
| `xp_per_min` | value | 912 |
| `last_hits` | value | 178 |
| `denies` | value | 6 |
| `hero_damage` | value | 23401 |
| `tower_damage` | value | 8816 |
| `hero_healing` | zero | 0 |
| `times` | missing | — |
| `gold_t` | missing | — |
| `xp_t` | missing | — |
